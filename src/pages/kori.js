                ...
                <div className="columns is-centered margin-top-2">
                    <div className="column is-8">
                        <p className="is-size-6 margin-bottom">
                            ...
                            日中の気温も低く保たれていなければ、池の氷が厚く成長しないからです。
                ...
                <div className="columns is-centered margin-top-2">
                    <div className="column is-8">
                        <p className="is-size-6 margin-bottom">
                            ...
                            雪は空気中の微小な塵を巻き込んで大きくなります。これが天然氷にとっては不純物となってしまうのです。
                            また、雪は氷に比べて温度が高いので雪がつもると氷を雪が混ざってしまうのです。
                            <br /><br />
                            北海道以外の地域でも、もちろん雪は降ります。そのため天然氷を作る人たちは冬場休まず
                ...
                <div className="columns is-centered margin-top-2">
                    <div className="column is-8">
                        <p className="is-size-6 margin-bottom">
                            ...
                            成長していくことになります。
                            <br /><br />
                            これによって、まるで水中の不純物を押しだしながら氷が成長し、不純物を含まない綺麗な
                            氷が出来上がるのです。
                            <br /><br />
                            これとは反対に、通常の氷は冷凍庫の低い温度で急激に冷えて固まります。
                            凍るスピードが早すぎて、水の純度も関係なく、かつ上下左右均一に冷えて固まっていくため、
